...
static std::vector<std::string> s_Preset_print_options {
    "layer_height", "initial_layer_print_height", "object_initial_layer_height", "object_initial_layer_speed", "object_initial_layer_line_width", "wall_loops", "alternate_extra_wall", "slice_closing_radius", "spiral_mode", "spiral_mode_smooth", "spiral_mode_max_xy_smoothing", "spiral_starting_flow_ratio", "spiral_finishing_flow_ratio", "slicing_mode",
    ...
    "wave_overhang_print_speed", "wave_overhang_supported_speed", "wave_overhang_perimeter_speed", "wave_overhang_travel_speed", "wave_overhang_fan_speed",
    ...
    "infill_direction", "solid_infill_direction", "initial_layer_infill_direction", "counterbore_hole_bridging","infill_shift_step", "sparse_infill_rotate_template", "solid_infill_rotate_template", "symmetric_infill_y_axis","skeleton_infill_density", "infill_lock_depth", "skin_infill_depth", "skin_infill_density",
